  ...
  module Core
    ...
    module ProductFilters
      ...
      def ProductFilters.simple_scopes
        conds = [ ["Prezzo crescente",   Spree::Product.ascend_by_master_price.values[:order]],
                  ["Prezzo decrescente",  Spree::Product.descend_by_master_price.values[:order]],
                  ["Nome A-Z",          Spree::Product.ascend_by_name.values[:order]],
                  ["Nome Z-A",          Spree::Product.descend_by_name.values[:order]] ]
        {
          name:   'Ordina per:',
