...
module Spree
  class OrderMailer < BaseMailer
    ...
    def approve_email(order, resend = false)
      ...
      attachments['Coalca Shop - condizioni di vendita.pdf'] = open(encode("https://coalca.blob.core.windows.net/cdn/Condizioni Generali di Vendita - Coalca Shop.pdf")).read
